...
namespace Xrm.Framework.CI.PowerShell.Common
{
    public static class IOrganizationServiceExtension
    {
        ...
        public static void UpdateEntityField<TAttributeType>(this IOrganizationService organizationService,
            string entityName, Guid entityId, string attributeName, TAttributeType attributeValue)
        {
